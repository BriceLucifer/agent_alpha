...
class MCPClient:
    ...
    def __init__(self):
        ...
        self.llm_client = OpenAI(
            ...
            base_url=os.getenv("DEEPSEEK_BASE_URL") # 从环境变量中获取 API 基础 URL
        )
        # 从环境变量获取模型名称
    ...
    async def process_query(self, query: str) -> str:
        ...
        # 打印可用工具信息，便于调试
        print(f"当前 MCP 服务所有工具🔧列表: {available_tools}\n--------------------------------\n")
        ...
        if hasattr(reply, "tool_calls") and reply.tool_calls:
            ...
            for tool_call in reply.tool_calls:
                ...
                try:
                    ...
                    final_content = "DeepSeek🐳回答：" + final_response.choices[0].message.content
